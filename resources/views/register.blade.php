...
<div class="container">
            <form class="form-horizontal" role="form" method="POST" action="/register">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="email" id="email" name="email" placeholder="@example.com" class="form-control" name= "email">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="address" name="address" placeholder="Please write your correct address" class="form-control">
                    </div>
                </div>
                <div class="form-group">
